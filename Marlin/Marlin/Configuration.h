...
#define STRING_CONFIG_H_AUTHOR "Martim Pegueiro" // Who made the changes.
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 250, 250, 3, 300 }
...
#define HOMING_FEEDRATE_MM_M { (150*60), (150*60), (9*60) }
