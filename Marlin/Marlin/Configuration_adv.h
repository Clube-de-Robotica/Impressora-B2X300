...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define EVENT_GCODE_SD_ABORT "G91\nG1 Z10 E-5 F2300\nG90\nG0 X10 Y200 F3000"      // G-code to run on SD Abort Print (e.g., "G28XY" or "G27")
  ...
  #define POWER_LOSS_RECOVERY
    ...
    #define POWER_LOSS_PIN             11 // Pin to detect power-loss. Set to -1 to disable default pin on boards without module, or comment to use board default.
...
#define BABYSTEPPING
  ...
  #define DOUBLECLICK_FOR_Z_BABYSTEPPING  // Double-click on the Status Screen for Z Babystepping.
    ...
    #define DOUBLECLICK_MAX_INTERVAL 700   // Maximum interval between clicks, in milliseconds.
